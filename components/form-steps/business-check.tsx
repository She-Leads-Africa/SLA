...
export default function BusinessCheck({ value, onChange, onNext, onBack }: BusinessCheckProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 p-6 rounded-lg">
        <h3 className="text-lg font-medium mb-4">Do you already have a business and is your business less than 3 years old?</h3>
